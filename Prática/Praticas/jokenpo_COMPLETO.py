...
while True:
    ...
    escolha_jogador = input(
        "Digite: pedra, papel ou tesoura para jogar, 0 para acabar ou 1 para limpar o histórico de jogadas: "
    )
    ...
    if escolha_jogador == escolha_maquina:
        ...
        and escolha_maquina == "tesoura"
        or escolha_jogador == "papel"
        and escolha_maquina == "pedra"
        or escolha_jogador == "tesoura"
        and escolha_maquina == "papel"
    ):
